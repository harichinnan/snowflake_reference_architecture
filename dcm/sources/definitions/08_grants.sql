...
-- ---- LOADER: write RAW + BRONZE only ---------------------------------------
GRANT USAGE ON SCHEMA {{ database }}.RAW    TO ROLE CLAIMS_LOADER;
GRANT USAGE ON SCHEMA {{ database }}.BRONZE TO ROLE CLAIMS_LOADER;
GRANT INSERT ON FUTURE TABLES IN SCHEMA {{ database }}.BRONZE TO ROLE CLAIMS_LOADER;
